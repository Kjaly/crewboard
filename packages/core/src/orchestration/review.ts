...
export async function acceptTasks(root: string, taskIds: string[], now: Date, verdicts: Record<string, Verdict> = {}, shownEvidence: Record<string, string | undefined> = {}): Promise<string[]> {
